...
const LATAM_OUTCOMES: typeof AFTER_SIGN_OUTCOMES = [
  ...
  { icon: "users", titleKey: "footer.mexicoToUs", bodyKey: "dash.corridorMexico", to: "/mexico-to-us", linkKey: "latamDesk.openKit" },
  { icon: "users", titleKey: "footer.colombiaToUs", bodyKey: "dash.corridorColombia", to: "/colombia-to-us", linkKey: "latamDesk.openKit" },
  ...
  { icon: "badge", titleKey: "footer.acta", bodyKey: "dash.corridorActa", to: "/acta", linkKey: "latamDesk.openKit" },
  { icon: "badge", titleKey: "footer.cita", bodyKey: "dash.corridorCita", to: "/consular-appointment", linkKey: "latamDesk.openKit" },
  { icon: "badge", titleKey: "footer.eadTps", bodyKey: "dash.corridorEad", to: "/ead-tps", linkKey: "latamDesk.openKit" },
  { icon: "badge", titleKey: "footer.phoneBank", bodyKey: "dash.corridorPhoneBank", to: "/phone-and-bank", linkKey: "latamDesk.openKit" },
  { icon: "users", titleKey: "landing.out3.title", bodyKey: "landing.out3.body", to: "/packets/latam-contractor", linkKey: "landing.out3.link" },
  { icon: "duplicate", titleKey: "landing.out6.title", bodyKey: "landing.out6.body", to: "/packets/collect", linkKey: "landing.out6.link" },
        ...
        <div className="hero-inner hero-stack">
          ...
          {latamDoor && (
            <div className="hero-latam-cta">
              <LatamSearchBox source="hero-es" compact showCircle circleIsCta />
              <Link
                to={cobroSendTo}
