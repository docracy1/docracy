...
export default function FirstDocumentPrompt({ mobileOnly = false }: { mobileOnly?: boolean }) {
  ...
  return (
    <div className={`first-document-prompt${mobileOnly ? " first-document-prompt-mobile" : ""}`}>
      ...
      <button type="button" className="btn-primary btn-lg" onClick={() => setModalOpen(true)}>
        Upload document
      </button>
