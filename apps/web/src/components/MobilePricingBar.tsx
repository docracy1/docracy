...
function shouldHideDock(pathname: string): boolean {
  if (pathname.startsWith("/sign/") || pathname.startsWith("/status/") || pathname.startsWith("/signed/") || pathname.startsWith("/es/firmado/") || pathname.startsWith("/income-proof/") || pathname.startsWith("/es/constancia/") || pathname.startsWith("/1099-season/") || pathname.startsWith("/es/temporada-1099/") || pathname.startsWith("/embed/")) {
    return true;
  }
