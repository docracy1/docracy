...
const SEO_CATALOG_KEY: Record<SeoPage, string> = {
  ...
  kitaAlternative: "kita",
  alegraAlternative: "alegra",
  siigoAlternative: "siigo",
  boundlessAlternative: "boundless",
  citizenpathAlternative: "citizenpath",
  visaServiceAlternative: "visaService",
