...
export const PLAN_ROWS: Array<{
  ...
  { labelKey: "plan.whatsappLinks", free: "plan.val.whatsappFree", paid: "plan.val.whatsappPaid", enterprise: "plan.val.whatsappEnterprise" },
  ...
  { labelKey: "plan.paymentLink", free: false, paid: true },
  { labelKey: "plan.cobro", free: false, paid: true },
  { labelKey: "plan.taxYearLocker", free: false, paid: true },
