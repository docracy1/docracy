const HCCH = "https://www.hcch.net/en/instruments/conventions/authorities1/?cid=41";
...
/** Spanish LATAM → US doors. Official apostille URLs only when we verified the government host. */
export const LATAM_COUNTRY_CORRIDORS: LatamCountryCorridor[] = [
  ...
  },
  {
    ...
    apostilleLabelEn: "MINEX / HCCH competent authority",
    apostilleLabelEs: "MINEX / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "We do not host a MINEX form. HCCH lists the competent authority. We don't apostille.",
    officialNoteEs: "No hospedamos un formulario MINEX. HCCH lista la autoridad competente. No apostillamos.",
    cobroCurrency: "GTQ",
  ...
  },
  {
    ...
    cityEn: "Tegucigalpa",
    cityEs: "Tegucigalpa",
    apostilleLabelEn: "SRE / HCCH competent authority",
    apostilleLabelEs: "SRE / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists who apostilles Honduran public documents. We don't.",
    officialNoteEs: "HCCH lista quién apostilla documentos públicos hondureños. Nosotros no.",
    cobroCurrency: "HNL",
  ...
  },
  {
    ...
    cityEn: "San Salvador",
    cityEs: "San Salvador",
    apostilleLabelEn: "RREE / HCCH competent authority",
    apostilleLabelEs: "RREE / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists the Salvadoran competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad salvadoreña. No apostillamos.",
    cobroCurrency: "USD",
  ...
  },
  {
    ...
    apostilleLabelEn: "MIREX / HCCH competent authority",
    apostilleLabelEs: "MIREX / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists who apostilles Dominican public documents. We don't.",
    officialNoteEs: "HCCH lista quién apostilla documentos públicos dominicanos. Nosotros no.",
    cobroCurrency: "DOP",
  ...
  },
  {
    ...
    cityEn: "La Paz",
    cityEs: "La Paz",
    apostilleLabelEn: "Cancillería / HCCH competent authority",
    apostilleLabelEs: "Cancillería / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists the Bolivian competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad boliviana. No apostillamos.",
    cobroCurrency: "BOB",
  ...
  },
  {
    ...
    apostilleLabelEs: "RREE / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists Costa Rica's competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad de Costa Rica. No apostillamos.",
    cobroCurrency: "CRC",
  ...
  },
  {
    ...
    cityEn: "Managua",
    cityEs: "Managua",
    apostilleLabelEn: "MINREX / HCCH competent authority",
    apostilleLabelEs: "MINREX / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists the Nicaraguan competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad nicaragüense. No apostillamos.",
    cobroCurrency: "NIO",
  ...
  },
  {
    ...
    apostilleLabelEs: "Cancillería / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists Uruguay's competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad uruguaya. No apostillamos.",
    cobroCurrency: "UYU",
  ...
  },
  {
    ...
    cityEn: "Asunción",
    cityEs: "Asunción",
    apostilleLabelEn: "MRE / HCCH competent authority",
    apostilleLabelEs: "MRE / autoridad HCCH",
    officialHref: HCCH,
    officialNoteEn: "HCCH lists Paraguay's competent authority. We don't apostille.",
    officialNoteEs: "HCCH lista la autoridad paraguaya. No apostillamos.",
    cobroCurrency: "PYG",
  ...
  },
  {
    ...
    cityEn: "Havana",
    cityEs: "La Habana",
    apostilleLabelEn: "MINREX / HCCH (Apostille in force since 2023)",
    apostilleLabelEs: "MINREX / HCCH (Apostilla vigente desde 2023)",
    officialHref: HCCH,
    officialNoteEn: "Cuba joined the Apostille Convention (in force 2023). HCCH lists MINREX as competent authority. Older docs may still need consular legalization. We do neither.",
    officialNoteEs: "Cuba se adhirió al Convenio de Apostilla (vigente 2023). HCCH lista a MINREX. Documentos viejos a veces siguen pidiendo legalización consular. No hacemos ninguna.",
    cobroCurrency: "USD",
