...
const es: Messages = {
  ...
  "prepare.whatsappQuotaHint": "Las cuentas gratis tienen 2 invitaciones firmadas por WhatsApp al mes — te quedan {{remaining}} este mes. Mejora el plan para uso ilimitado.",
