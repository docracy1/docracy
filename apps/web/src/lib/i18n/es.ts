...
const es: Messages = {
  ...
  "hero.uploadCircleTitle": "Suelta tu PDF aquí",
  "hero.uploadCircleSub": "Firma gratis · sin registro",
  "hero.uploadCircleCaption": "Después agregas los firmantes — nada se envía hasta que estés listo. ¿Word? Expórtalo a PDF primero.",
