...
const es: Messages = {
  ...
  "cobro.faq.4.a": "Sí, cada ~30 días hasta que expire el archivo, más un reenvío manual desde tu cuenta. Cada WhatsApp usa cuota.",
  ...
  "cobro.howTo1": "Abre cobro en una cuenta de pago y adjunta el PDF.",
