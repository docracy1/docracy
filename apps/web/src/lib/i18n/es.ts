...
const es: Messages = {
  ...
  "footer.legalReviewLead": "Plantillas gratuitas revisadas por BOECK Law (Colegio de Abogados de Liechtenstein) y",
  "footer.legalReviewTrail": ", contador público.",
  ...
  "freeTemplates.legalReviewLead": "Cada plantilla de Docracy abajo ha sido revisada por BOECK Law (Colegio de Abogados de Liechtenstein) y",
  "freeTemplates.legalReviewTrail": ", contador público, para garantizar la corrección.",
