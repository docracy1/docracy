...
const es: Messages = {
  ...
  "prepare.tapPlaceHint": "Elige un tipo de campo y toca dónde debe ir en el PDF.",
  "prepare.placeModeBanner": "Colocando {{type}} · {{signer}}",
  "prepare.placeModeHint": "Toca el documento para colocar este campo",
  "prepare.donePlacing": "Listo",
  "prepare.setup": "Configurar",
  "prepare.hideSetup": "Ocultar",
  "prepare.mobilePlaceInstruction":
    "Elige un firmante, toca Colocar campo y luego toca el documento donde debe ir.",
