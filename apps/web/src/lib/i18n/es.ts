...
const es: Messages = {
  ...
  "hero.uploadCircleSub": "Firma gratis · sin registro",
  ...
  "hero.sub": "Suelta un PDF, agrega firmantes, listo. Plantillas legales gratis. Sin cobro por usuario.",
  ...
  "freeTemplates.heroHeadline": "Contratos y plantillas gratis",
  "freeTemplates.heroSub":
    "Acuerdos revisados por abogados, listos para completar y enviar. Busca, abre uno y recoge firmas en minutos — gratis.",
  "freeTemplates.templateCount": "{{count}} plantillas listas para firmar",
  "freeTemplates.howItWorksLink": "Cómo funciona el Marketplace →",
  "freeTemplates.searchPlaceholder": "Buscar contratos — NDA, oferta, arrendamiento…",
  ...
  "tpl.detail.cta": "Firma este documento gratis",
