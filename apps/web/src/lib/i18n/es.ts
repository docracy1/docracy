...
const es: Messages = {
  ...
  "uploadCircle.googleHint": "Debe estar como «Cualquiera con el enlace». ¿Word? Expórtalo a PDF primero.",
  ...
  "hero.sub": "Plantillas legales gratuitas, firma instantánea por WhatsApp y un flujo de contratos moderno — sin cobro por usuario.",
