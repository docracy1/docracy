...
const es: Messages = {
  ...
  "landing.outcomesSub":
    "Firmar sigue gratis. El plan de pago es el paquete: una constancia para compartir, cobro por WhatsApp, un CSV 1099, kits de oficios y contratación LATAM, y pedir un W-9.",
  ...
  "docs.taxYear.body":
    "Las cuentas de pago abren /es/temporada-1099 (inglés: /1099-season) y descargan un CSV de cada documento completado en un año calendario: título, contrapartes, correos, monto, moneda, URL de pago, fecha de archivo, URL de la página firmada. No leemos TIN con OCR ni presentamos 1099 ante el IRS. El CSV es un índice de lo que ya enviaste por Docracy.",
  "docs.cobro.title": "Cobro por WhatsApp (pago)",
  "docs.cobro.body":
    "Envía un PDF con tu checkout https — sin firmantes. El destinatario recibe correo y/o WhatsApp (plantilla viva signing_invite, variable signing_link) con /es/firmado/… el archivo y el botón de pagar. Aviso opcional cada 30 días. Docracy nunca cobra el dinero. Abre /es/cobro.",
  ...
  "taxYear.kicker": "Pago · año fiscal",
  "taxYear.heroTitle": "Casillero 1099: cada archivo firmado, un CSV para tu contador",
  "taxYear.heroSub":
    "W-9s, acuerdos de contratista y facturas que ya enviaste por Docracy, listados por año calendario. Exporta nombres, correos, montos y enlaces de la copia. No presentamos 1099 ni leemos TIN del PDF.",
  ...
  "taxYear.problem":
    "Llega enero y el W-9 desapareció. Gmail no encuentra nada. El PDF firmado vivió nueve días en una herramienta gratis y se borró. Tu contador quiere una lista, no una búsqueda.",
  "taxYear.solutionTitle": "Qué es esto",
  "taxYear.solution":
    "En el plan de pago, Docracy ya guarda los PDF hasta el 15 de abril siguiente o 13 meses. El casillero es ese archivo, filtrado a un año calendario, más una hoja que puedes darle a un contador. Solo columnas honestas: fechas, títulos, contrapartes, montos que tú escribiste, tu URL de cobro.",
  "taxYear.feat1": "Cada documento completado en ese año — no solo los que se titulan W-9.",
  "taxYear.feat2": "CSV: año, fecha de cierre, título, nombres, correos, monto, moneda, URL de pago, fecha de archivo, URL de la copia.",
  "taxYear.feat3": "Sin OCR de TIN, sin presentación ante el IRS, sin Gusto. El W-9 firmado sigue en la bóveda.",
  "taxYear.feat4": "Firmar sigue gratis. El plan de pago es cómo los archivos (y esta lista) llegan a temporada 1099.",
  ...
  "taxYear.faq.1.q": "¿Docracy presenta el 1099-NEC ante el IRS?",
  "taxYear.faq.1.a": "No. El casillero es una lista de documentos que ya completaste aquí, más un CSV. Tú o tu contador presentan.",
  "taxYear.faq.2.q": "¿Extraen números de Seguro Social o EIN?",
  "taxYear.faq.2.a": "No. Nunca leemos el PDF para sacar el TIN. Conserva el W-9 firmado en la bóveda y entrégaselo a tu contador.",
  "taxYear.faq.3.q": "¿Qué lleva el CSV?",
  "taxYear.faq.3.a": "Año, fecha de cierre, título, nombres y correos de contraparte, monto y moneda si pegaste un enlace de cobro, fecha de archivo y la URL de la copia.",
  "taxYear.faq.4.q": "¿El casillero es gratis?",
  "taxYear.faq.4.a": "No. En el plan gratis los PDF se borran a los 9 días. El plan de $10/mes los conserva hasta temporada fiscal y desbloquea esta lista.",
  ...
  "taxYear.howToName": "Cómo exportar un CSV de temporada 1099 para tu contador",
  "taxYear.howTo1": "Envía y completa archivos de contratista en Docracy durante el año calendario (el plan de pago conserva los PDF).",
  "taxYear.howTo2": "Abre el casillero temporada 1099 y elige el año fiscal.",
  "taxYear.howTo3": "Descarga el CSV de títulos, contrapartes, montos y URLs de la copia.",
  "taxYear.howTo4": "Entrega la hoja y los W-9 a tu contador — nosotros no presentamos ante el IRS.",
  "cobro.seoTitle": "Cobra por WhatsApp — sin firma | Docracy",
  "cobro.seoDescription":
    "Envía un PDF y tu enlace de PayPal, Stripe o Mercado Pago por WhatsApp. Sin firma. Docracy nunca cobra el dinero. Plan de $10/mes, aviso a 30 días.",
  "cobro.kicker": "Pago · cobro",
  "cobro.heroTitle": "Cobra por WhatsApp. No hace falta que firmen.",
  "cobro.heroSub":
    "Pega tu PayPal.me, Stripe Payment Link o Mercado Pago, adjunta la factura o el contrato y envía. La otra persona abre una página con el archivo y tu checkout. Docracy nunca cobra el pago.",
  ...
  "cobro.solution":
    "Una página de archivo + pago, sin cadena de firmantes. Correo y/o WhatsApp con la misma plantilla viva de las invitaciones a firmar. Recordatorio opcional cada 30 días hasta la fecha de archivo. Tu checkout, tu dinero.",
  "cobro.feat1": "No hace falta firmar — el PDF está disponible de inmediato.",
  "cobro.feat2": "WhatsApp usa la plantilla aprobada signing_invite (signing_link = esta página). Cuenta para la cuota mensual.",
  ...
  "cobro.faq.3.q": "¿Es una plantilla nueva de Meta?",
  "cobro.faq.3.a": "No. Reutilizamos la plantilla viva signing_invite y ponemos la URL de pago en la variable signing_link.",
  "cobro.faq.4.q": "¿Los vuelven a avisar?",
  "cobro.faq.4.a": "Sí, cada ~30 días hasta que expire el archivo o marques el cobro como pagado, más un reenvío manual desde tu cuenta. Cada WhatsApp usa cuota.",
  ...
  "cobro.howTo2": "Pega tu PayPal.me, Stripe Payment Link o Mercado Pago.",
  ...
  "payerShare.sendYours": "Abrir el casillero temporada 1099",
  ...
  "docs.payerShare.title": "Compartir el año 1099 con un contador",
