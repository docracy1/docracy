...
const es: Messages = {
  ...
  "blog.tryFreeSampleNda": "Firma tu primer documento gratis",
  "blog.uploadW9": "Sube y firma tu W-9 en 30 segundos",
  "blog.tryShortLink": "Probar gratis — NDA de ejemplo",
  "blog.seePricing": "Ver precios",
  "blog.ctaAlso": "También:",
  "blog.ctaCompare": "Comparar precios de firma electrónica",
  "blog.ctaTemplate": "Plantilla gratis de NDA mutuo",
  "blog.ctaNoAccount": "No necesitas cuenta para hasta 2 firmantes.",
  "blog.newBadge": "Nuevo",
  ...
  "dash.freeTemplatesSub":
    "Documentos listos para usar de Docracy y la comunidad — elige uno para rellenar sus campos de firma automáticamente.",
  "dash.more": "Más",
  "dash.new": "+ Nuevo",
  ...
  "dash.templatesPaidSub":
    "El $10/mes es cobro, constancia y el I-9. Las plantillas reutilizables van incluidas — no es por lo que se paga.",
  ...
  "dash.keepFile": "Guardar I-9 y constancia — $10/mes",
  "dash.copySignedLink": "Copiar enlace firmado + pago",
  "dash.archiveNag": "Un PDF firmado se borra en menos de 2 días. $10/mes guarda el I-9 y la constancia.",
  "dash.void": "Anular",
  ...
  "firstDoc.modalSub": "No necesitas cuenta para enviar o firmar. Gratis hasta 2 firmantes.",
  "firstDoc.modalTitle": "Sube tu PDF o Google Doc",
  "firstDoc.prompt": "¿Listo? Sube tu primer documento — tarda unos 30 segundos.",
  "firstDoc.upload": "Subir tu primer documento",
  "firstDoc.uploadPdf": "Subir PDF",
  "footer.about": "Acerca de",
  "footer.importGuide": "Importar desde DocuSign/eversign",
  "footer.importDocusign": "Importar desde DocuSign",
  "footer.importEversign": "Importar desde eversign / Xodo",
  "footer.importHellosign": "Importar desde HelloSign",
  "footer.importPandadoc": "Importar desde PandaDoc",
  "footer.importAdobe": "Importar desde Adobe Sign",
  "footer.importContractbook": "Importar desde Contractbook",
  "footer.importOnlinesignature": "Importar desde OnlineSignature",
  ...
  "footer.aiDrafting": "Redacción de contratos con IA",
  "footer.integrationsAi": "Integraciones con asistentes de IA",
  ...
  "footer.industry": "Industria",
  "footer.developersHeading": "Desarrolladores",
  "footer.connect": "Conectar",
  "footer.solutions": "Soluciones",
  "footer.resources": "Recursos",
  "footer.whatsappSigning": "Firma por WhatsApp",
  "footer.apiDocs": "Documentación de la API",
  "footer.seeAllIndustries": "Ver todas las industrias",
  "footer.industryFreelancers": "Freelancers",
  "footer.industryRealEstate": "Bienes raíces",
  ...
  "hero.hint": "Sin tarjeta · enlace mágico para una cuenta gratis, o empieza sin cuenta abajo.",
  "hero.uploadCircleTitle": "Sube tu primer documento",
  "hero.uploadCircleSub": "Empieza a firmar ahora · gratis · sin registro",
  "hero.uploadCircleCaption": "Después agregas los firmantes — nada se envía hasta que estés listo.",
  "uploadCircle.orGoogle": "O Google Doc",
  "uploadCircle.googleHint": "El enlace debe permitir «Cualquiera con el enlace».",
  "uploadCircle.scanDocument": "Escanea un documento",
  ...
  "hero.stat.blockchain": "sello de tiempo en blockchain, gratis",
  ...
  "hero.sub":
    "Pega tu Mercado Pago o PayPal, manda el PDF y arma la constancia que te pide el arrendador. Firmar sigue gratis. $10 al mes es cobrar y probar el año — Docracy no se queda un peso.",
  ...
  "hero.title": "Basta de perseguir el pago.\nCobra por WhatsApp.",
  ...
  "landing.aiCta": "Ilimitado — $10/mes",
  "landing.aiMcp.body":
  ...
  "landing.faq1.a":
    "Una entrada de firma electrónica gratis más paquetes de pago después de firmar. Firma contratos sin cuenta (hasta 2 personas). El plan de $10/mes es constancia, cobro por WhatsApp, archivo fiscal para tu contador, kits de oficios y pedir W-9 / RFC — no es un W-2, ni carta bancaria, ni tarifa por firma.",
  ...
  "landing.faq3.a":
    "Los documentos se cifran en tránsito y en reposo, con registro de auditoría. Las firmas son SES pensadas para respaldar ESIGN, UETA y eIDAS. No verificamos identidad y aún no reclamamos SOC 2 del producto — ver /trust.",
  "landing.faq3.q": "¿Es seguro / válido legalmente Docracy.io?",
  "landing.faq4.a":
  ...
  "landing.faq6.q": "¿Puedo enviar una factura por WhatsApp sin firma?",
  "landing.faq6.a":
    "Sí en el plan de pago. Abre /es/cobro, adjunta el PDF y pega tu PayPal, Stripe o Mercado Pago. Docracy nunca cobra el dinero. Inglés: /cobro.",
  "landing.faq7.q": "¿Presentan el 1099 o conservan los W-9 hasta la temporada fiscal?",
  "landing.faq7.a":
    "No presentamos ante el IRS. El plan de pago conserva los PDF hasta el próximo 15 de abril o 13 meses y exporta un CSV en /es/temporada-1099. Nunca leemos TIN con OCR.",
  ...
  "landing.out1.body":
    "Envía el PDF y tu enlace de Mercado Pago o PayPal — sin firma. Docracy nunca cobra el pago.",
  "landing.out1.link": "Enviar un cobro",
  "landing.out2.title": "Archivo fiscal",
  "landing.out2.body":
    "Cada archivo completado del año calendario, más una hoja para tu contador. No es presentación ante el IRS.",
  "landing.out2.link": "Abrir el archivo",
  "landing.out3.title": "Contrata en LATAM",
  "landing.out3.body":
  ...
  "landing.out5.title": "Kit oficios",
  "landing.out5.body":
    "Orden de trabajo y change order son gratis. Luego cobro con tu Square o PayPal. No es Jobber. No es un waiver de gravamen.",
  "landing.out5.link": "Abrir el kit de oficios",
  "landing.out6.title": "Pídeme tu W-9",
  "landing.out6.body":
  ...
  "landing.templatesSub": "Contratos gratis listos para completar y enviar — elige uno y recoge firmas en minutos.",
  "landing.uc1.body":
  ...
  "login.ctaLatam": "Activar cobro y constancia — $10/mes",
  "login.subLatam":
  ...
  "mcp.freeToolBody":
    "Conecta https://mcp.docracy.io/mcp sin clave API para explorar plantillas legales abiertas, obtener enlaces de preparación y consultar un enlace de firma/estado. Los agentes nunca envían ni firman — una persona termina en docracy.io.",
  "mcp.paidRequired": "¿Quieres buscar tus propios documentos?",
  "mcp.title": "MCP para plantillas, estado y tus documentos",
  "nav.blog": "Blog",
  ...
  "plan.val.whatsappFree": "1/mes",
  "plan.val.whatsappPaid": "10/mes, luego $0.50 cada una",
  "plan.val.whatsappEnterprise": "50/mes (uso justo)",
  ...
  "prepare.googleDocPlaceholder": "Pega un enlace de Google Docs",
  "prepare.googleDocImportBtn": "Importar",
  "prepare.googleDocImporting": "Importando…",
  "prepare.googleDocHint": "Gratis, sin necesidad de cuenta — el documento debe estar compartido como \"Cualquier persona con el enlace puede verlo.\" ¿Tienes un documento de Word? Expórtalo a PDF primero (Archivo → Descargar → PDF) y luego súbelo.",
  "prepare.googleDocImportError": "No se pudo importar ese documento — inténtalo de nuevo.",
  "prepare.myself": "+ Yo",
  "prepare.recurring": "🔁 Recurrente",
  "prepare.saveTemplate": "Guardar como plantilla",
  "prepare.submitMarketplace": "Enviar al Marketplace",
  "prepare.submitMarketplaceHint": "Comparte la estructura vacía de este documento públicamente para que otros la usen gratis — revisada por un administrador de Docracy antes de publicarse. No necesitas cuenta.",
  "prepare.marketplaceSubmitted": "Enviado — un administrador de Docracy lo revisará antes de que aparezca en el Marketplace.",
  ...
  "prepare.uploadHint": "Sube el PDF que quieres firmar — arrástralo al círculo, o pega un enlace de Google Docs dentro.",
  ...
  "sendMoney.emailPlaceholder": "tu@ejemplo.com",
  "sendMoney.countryLabel": "¿A qué país vas a enviar dinero?",
  "sendMoney.countryPlaceholder": "Selecciona un país",
  "sendMoney.country.mx": "México",
  "sendMoney.country.co": "Colombia",
  "sendMoney.country.ar": "Argentina",
  "sendMoney.country.br": "Brasil",
  "sendMoney.country.sv": "El Salvador",
  "sendMoney.country.ec": "Ecuador",
  "sendMoney.country.pa": "Panamá",
  "sendMoney.country.cl": "Chile",
  "sendMoney.country.ve": "Venezuela",
  "sendMoney.country.other": "Otro país",
  "sendMoney.submit": "Unirme a la lista de espera",
  "sendMoney.submitting": "Enviando…",
  "sendMoney.successTitle": "Ya estás en la lista",
  "sendMoney.successBody": "Te escribiremos en cuanto enviar dinero esté disponible para tu país.",
  "sendMoney.errorGeneric": "Algo salió mal — inténtalo de nuevo.",
  "sendMoney.disclaimer": "Docracy nunca tendrá acceso a tus fondos. Las transferencias serán procesadas por un socio de pagos con licencia; Docracy no es un transmisor de dinero.",
  "sendMoney.signerCta": "¿Necesitas enviar o convertir dinero para tu familia?",
  "sendMoney.signerCtaLink": "Ver opciones para enviar dinero",
  ...
  "docs.paid.body1":
    "Firmar sigue siendo gratis. Una cuenta gratis lista los envíos en el panel hasta que el TTL de 9 días borra el PDF — no conserva el archivo. El plan de pago ($10/mes) conserva los PDF firmados hasta el próximo 15 de abril o 13 meses, te deja pegar tu enlace de PayPal/Stripe/Mercado Pago después de firmar (Docracy no se lleva un porcentaje), cobro por WhatsApp sin firma, un CSV de temporada 1099 para tu contador, más firmantes ilimitados, plantillas reutilizables, enlaces con PIN, cuentas de equipo, marca blanca, webhooks, MCP/Zapier, IA, carga automática a Dropbox/OneDrive/Box/Google Drive y las funciones de flujo abajo. Los kits de contratista EE. UU. y LATAM se pueden empezar gratis. Comparación completa en",
  ...
  "freeTemplates.comparePricing": "Comparar con DocuSign",
  "freeTemplates.trySample": "Probar un NDA de ejemplo gratis",
  ...
  "mcp.client.gemini.name": "Gemini y agentes personalizados",
  "mcp.client.gemini.sub": "(cualquier cliente compatible con MCP)",
  "mcp.client.gemini.setup":
    "Agrega la URL MCP Streamable HTTP (token opcional para plantillas gratis; obligatorio para find_documents).",
  "mcp.client.gemini.use":
    "Pide al agente list_templates para un NDA, luego draft_from_template con las notas del trato.",
  "mcp.toolListTemplates": "list_templates (gratis) — explora plantillas de la biblioteca gratis + Marketplace por palabra clave.",
  "mcp.toolGetTemplate": "get_template (gratis) — metadatos, pistas de redacción y URL de preparación de un slug.",
  "mcp.toolDraftFromTemplate": "draft_from_template (gratis) — brief de redacción + enlace de preparación; nunca envía solo.",
  "mcp.disclaimer":
  ...
  "mcp.intro2":
    " servidor para que Claude, ChatGPT, Cursor y agentes tipo Gemini exploren plantillas legales de confianza y consulten el estado de firma — sin salir del chat.",
  "mcp.paidBody":
  ...
  "mcp.readOnlyNote":
    "Las herramientas de plantillas y check_status son gratis. find_documents necesita una clave API de pago. Nada se envía ni se firma sin una persona en docracy.io.",
  ...
  "mcp.toolsIntro": "Herramientas disponibles por MCP:",
  "mcp.useLabel": "Úsalo:",
  "mcp.zapierBody":
  ...
  "seo.home.title": "Docracy — Basta de perseguir el pago. Cobra por WhatsApp.",
  ...
  "seo.sendMoney.title": "Enviar Dinero a Latinoamérica — Docracy",
  "seo.sendMoney.description":
    "Envía y convierte dinero a México, Colombia y el resto de Latinoamérica usando stablecoins, a un mejor tipo de cambio que un banco o Western Union. Únete a la lista de espera.",
  ...
  "seo.kita.title": "Alternativa a Kita — cobro por WhatsApp, sin CFDI | Docracy",
  ...
  "seo.alegra.title": "Alternativa a Alegra — firma y cobro, no contabilidad | Docracy",
  "seo.alegra.description":
    "Alternativa a Alegra cuando necesitas firma y tu link de Mercado Pago — no factura PAC. Firmar gratis ≤2. $10/mes, 0% de recorte.",
  ...
  "seo.mcp.title": "Servidor MCP para plantillas legales y estado de firma | Docracy",
  "seo.mcp.description":
    "Conecta Claude, ChatGPT, agentes tipo Gemini o Cursor a Docracy vía MCP: listar plantillas, redactar desde estándares, check_status (gratis) y find_documents (pago).",
  "seo.ai.title": "Firmas electrónicas con IA y plantillas de confianza para agentes | Docracy",
  "seo.ai.description":
    "Usa la IA de Docracy para colocar campos, explicar contratos, marcar riesgos y generar PDFs — más herramientas MCP para que los asistentes redacten desde plantillas legales abiertas y consulten el estado de firma.",
  ...
  "ai.feat.mcp.body":
    "Herramientas MCP: list_templates, get_template, draft_from_template (gratis), check_status (gratis) y find_documents (pago). Los asistentes nunca envían solos.",
  "ai.feat.templates.title": "Plantillas legales abiertas",
  "ai.feat.templates.body":
    "Más de 100 NDAs, acuerdos de contratista y cartas de oferta — úsalas en Preparar o vía MCP/API para que los agentes partan de estándares comunitarios, no de páginas en blanco.",
  ...
  "ai.faq.q3": "¿Pueden los agentes de IA usar plantillas de Docracy?",
  "ai.faq.a3":
    "Sí. Vía MCP (list_templates / get_template / draft_from_template) o la API pública del Marketplace. Los agentes obtienen enlaces de preparación y pistas de redacción; una persona revisa y envía en docracy.io.",
  "ai.faq.q5": "¿Esto es Google Gemini Enterprise for Legal?",
  "ai.faq.a5":
    "No. Docracy ejecuta sus propias herramientas de Workers AI y un servidor MCP abierto que cualquier agente compatible con MCP (incluidos agentes personalizados tipo Gemini) puede llamar. No revendemos el producto legal empresarial de Google.",
  ...
  "alt.priceStrip.title": "Precio con 5 personas en el equipo",
  "alt.priceStrip.savings": "Docracy ahorra {savings}/mes frente a este plan con {seats} licencias — tarifa plana por espacio de trabajo, no por usuario.",
  ...
  "dash.submitToMarketplace": "Enviar al Marketplace",
  "dash.marketplaceWarning":
    "Antes de enviar: asegúrate de que el documento no tenga nombres reales, direcciones ni datos de empresas escritos en el cuerpo del texto — solo se debe compartir la estructura vacía de la plantilla. Un administrador de Docracy revisa cada envío antes de publicarlo.",
  "dash.marketplaceCategory": "Categoría",
  "dash.marketplaceCategoryPlaceholder": "Elige una categoría (opcional)",
  "dash.marketplaceDescription": "Descripción breve",
  "dash.marketplaceDescriptionPlaceholder": "¿Para qué sirve esta plantilla?",
  "dash.marketplaceConfirm": "Enviar para revisión",
  "dash.marketplaceSubmitting": "Enviando…",
  "dash.marketplaceSuccess": "Enviado — un administrador de Docracy lo revisará antes de que aparezca en el Marketplace.",
  ...
  "prepare.freeSignerLimit": "El plan gratis admite hasta {{max}} firmantes. $10/mes es cobro, constancia y el I-9 — también incluye más firmantes.",
  ...
  "prepare.pdfOnly": "Solo se admiten archivos PDF aquí — para un Google Doc, pega su enlace en el círculo.",
  ...
  "prepare.pinChannelManual": "Yo le diré el PIN directamente",
  "prepare.pinChannelEmail": "Enviar PIN por correo",
  "prepare.pinChannelWhatsapp": "Enviar PIN por WhatsApp",
  "prepare.pinChannelSms": "Enviar PIN por SMS",
  "prepare.pinChannelHint": "Se envía ~30 segundos después del enlace de firma, como mensaje aparte.",
  "prepare.pinChannelHintWhatsapp": "Se envía ~30 segundos después del enlace de firma, como mensaje aparte — obligatorio para WhatsApp, para que el PIN sea un segundo factor real y no algo que le dices tú mismo.",
  ...
  "prepare.signerPinChannelAria": "Canal de envío del PIN del firmante {{n}}",
  ...
  "prepare.upgradeUnlimited": "Activar el paquete — $10/mes",
  ...
  "prepare.whatsappQuotaHintEnterprise": "Tu plan Enterprise incluye {{max}} invitaciones firmadas por WhatsApp al mes (uso justo) — te quedan {{remaining}} este mes.",
  ...
  "prepare.signerUpsellBody":
    "Nadie paga solo por más firmas. $10/mes es cobro, constancia y el I-9 guardado — y también incluye más firmantes.",
  ...
  "alt.kita.problem":
    "Kita es un buen producto de México: WhatsApp entra, cobro en Mercado Pago, CFDI 4.0 sale. Es el stack equivocado si ya tienes checkout y necesitas un contrato firmado más una página para pagar.",
  "alt.kita.solution":
    "El cobro de Docracy es archivo + tu checkout https. Firmar sigue gratis. El plan ($10/mes) conserva el PDF y desbloquea cobro, constancia y el CSV para tu contador. No afirmamos facturación SAT.",
  "alt.kita.c1": "0% del cobro — pegas Mercado Pago o PayPal.me",
  "alt.kita.c2": "Sin CFDI, sin PAC — límite honesto, escrito en la página",
  "alt.kita.c3": "Firma primero (gratis ≤2), luego cobro sin otra firma",
  "alt.kita.c4": "Archivo fiscal + CSV; constancia que puedes reenviar",
  "alt.kita.c5": "Kita es mejor si necesitas autofactura CFDI después de cada cobro",
  "alt.kita.ctaLabel": "Enviar un cobro — archivo + Mercado Pago",
  "alt.kita.compareLabel": "Kita vs Alegra vs Docracy",
  "alt.alegra.heroHeadline": "Alegra lleva los libros. Docracy firma el contrato y cobra el archivo.",
  "alt.alegra.heroSubheadline": "Cobro por WhatsApp con tu checkout. Sin timbre CFDI. No sustituye a tu contador.",
  "alt.alegra.problem":
    "Alegra es contabilidad más factura autorizada. Quien solo necesita “firma esto, luego paga este link” no debería comprar un libro y un paquete de timbres.",
  "alt.alegra.solution":
    "Docracy es el paso de firma y la página de archivo+pago. Pegas Mercado Pago. En el plan de pago los PDF llegan a temporada fiscal.",
  "alt.alegra.c1": "Firma secuencial gratis hasta dos personas",
  "alt.alegra.c2": "Cobro: PDF + tu página de Mercado Pago, sin firma extra",
  "alt.alegra.c3": "No somos PAC — no timbramos CFDI",
  "alt.alegra.c4": "$10/mes, 0% de lo cobrado",
  "alt.alegra.c5": "Alegra es mejor cuando necesitas facturas oficiales y libros",
  "alt.alegra.ctaLabel": "Enviar cobro o empezar una firma gratis",
  "alt.alegra.compareLabel": "Alegra vs Siigo vs Docracy",
  "alt.siigo.heroHeadline": "Siigo presenta la factura ante la DIAN. Docracy manda el archivo y tu checkout.",
  "alt.siigo.heroSubheadline": "Para contratistas que ya tienen un link de cobro — no reemplaza los libros de Siigo.",
  "alt.siigo.problem":
    "Siigo es facturación electrónica colombiana a escala. Un diseñador que cobra a un estudio de EE. UU. suele necesitar un contrato, un PDF y un link — no un documento DIAN.",
  "alt.siigo.solution": "NDA + acuerdo gratis, luego cobro de pago por WhatsApp con tu checkout. No presentamos ante la DIAN.",
  "alt.siigo.c1": "Sin timbre DIAN — no vamos a fingirlo",
  "alt.siigo.c2": "Archivo + tu checkout por WhatsApp, marcar pagado",
  "alt.siigo.c3": "Firmar gratis para dos; el plan conserva el archivo",
  "alt.siigo.c4": "Entrada /es a cobro y constancia",
  "alt.siigo.c5": "Siigo es mejor si debes emitir facturas autorizadas por la DIAN",
  "alt.siigo.ctaLabel": "Enviar un cobro por WhatsApp",
  ...
  "ai.templatesLink": "Explorar plantillas gratis →",
  "ai.developersLink": "Resumen para desarrolladores y API →",
  "ai.integrationsLink": "Integraciones con asistentes de IA →",

  "seo.developers.title": "Desarrolladores — API de plantillas, MCP y Zapier | Docracy",
  ...
  "seo.aiContractDrafting.title": "Redacción de contratos con IA desde plantillas abiertas | Docracy",
  ...
  "seo.enterprise.title": "Firmas electrónicas Enterprise con IA y MCP | Docracy",
  ...
  "seo.integrationsAi.title": "Conecta asistentes de IA a plantillas Docracy (MCP) | Docracy",
  ...
  "developers.heroTitle": "Plantillas legales y e-firma\npara tus agentes y apps.",
  "developers.heroSub":
    "API pública del Marketplace, servidor MCP remoto y automatización Zapier — con un humano en el bucle al enviar.",
  "developers.ctaPrimary": "Abrir docs de API →",
  "developers.ctaSecondary": "Guía de configuración MCP",
  "developers.featuresTitle": "Qué puedes conectar hoy",
  "developers.featuresSub": "Empieza con superficies de solo lectura. El envío sigue ocurriendo en Preparar de Docracy (o Zapier) con una persona en el bucle.",
  "developers.feat.templates.title": "API de plantillas y MCP",
  "developers.feat.templates.body": "GET /api/marketplace más MCP list_templates / get_template / draft_from_template — slugs, PDFs y URLs de preparación.",
  "developers.feat.mcp.title": "Servidor MCP remoto",
  "developers.feat.mcp.body": "https://mcp.docracy.io/mcp — Streamable HTTP. Plantillas + estado gratis; find_documents de pago con clave dk_.",
  "developers.feat.api.title": "Automatización Zapier / REST",
  "developers.feat.api.body": "Las claves API de pago crean documentos, listan plantillas del espacio y disparan webhooks — ver /docs#api.",
  "developers.feat.zapier.title": "Camino sin código",
  "developers.feat.zapier.body": "Dispara envíos desde las herramientas que ya usas sin montar MCP.",
  "developers.howTitle": "Ruta típica de integración",
  "developers.how.1": "Explora plantillas vía MCP o GET https://api.docracy.io/api/marketplace.",
  "developers.how.2": "Haz que tu agente personalice con notas de draft_from_template + keyClauses.",
  "developers.how.3": "Envía a la persona a la URL de preparación (o crea un doc vía Zapier/API).",
  "developers.how.4": "Usa check_status / find_documents para seguir el progreso desde el chat.",
  "developers.faqTitle": "FAQ para desarrolladores",
  "developers.faq.q1": "¿Hay una especificación OpenAPI pública?",
  "developers.faq.a1": "La tabla REST está en /docs#api. Los endpoints de listado/detalle/PDF del Marketplace son JSON público; las herramientas MCP se describen solas.",
  "developers.faq.q2": "¿Pueden los agentes enviar documentos de forma autónoma?",
  "developers.faq.a2": "No vía MCP hoy. MCP es lectura/asistencia de borrador. Enviar requiere la UI de Preparar o un flujo Zapier/API de pago con tu clave.",
  "developers.faq.q3": "¿Dónde está el origen abierto de plantillas?",
  "developers.faq.a3": "Las plantillas gratis van con el producto; las del Marketplace comunitario se revisan. Ver también github.com/docracy1/docracy-templates.",
  "developers.faq.q4": "¿Cómo obtengo una clave API?",
  "developers.faq.a4": "Inicia sesión en un plan Paid → Panel → crea un token API / MCP (dk_…). Las herramientas MCP de plantillas funcionan sin clave.",
  "developers.footerCta": "¿Listo para conectar plantillas de confianza a tu agente?",
  "developers.linkMcp": "Configuración del conector MCP →",
  "developers.linkAi": "Landing del producto de IA →",
  "developers.linkTemplates": "Biblioteca de plantillas gratis →",
  "developers.linkIntegrations": "Integraciones con asistentes de IA →",

  "aiDrafting.eyebrow": "Redacción",
  "aiDrafting.heroTitle": "Borradores de contrato\ndesde plantillas abiertas.",
  "aiDrafting.heroSub":
    "Empieza con un NDA o acuerdo de contratista de Docracy, personaliza con IA y envía a firma — sin cuenta para firmar.",
  "aiDrafting.ctaPrimary": "Empezar desde plantillas →",
  "aiDrafting.ctaSecondary": "Ver herramientas de IA",
  "aiDrafting.featuresTitle": "De plantilla a firma",
  "aiDrafting.featuresSub": "No entrenamos un playbook legal privado. Usamos plantillas revisadas más Workers AI en el flujo de Preparar.",
  "aiDrafting.feat.templates.title": "Bases de confianza",
  "aiDrafting.feat.templates.body": "NDAs, acuerdos de contratista, cartas de oferta y más — PDFs listos para firmar con campos.",
  "aiDrafting.feat.generate.title": "Ayuda de IA al redactar",
  "aiDrafting.feat.generate.body": "Describe el trato o genera un PDF desde una frase en Preparar (plan Paid).",
  "aiDrafting.feat.review.title": "Revisa antes de enviar",
  "aiDrafting.feat.review.body": "Resumen en lenguaje claro y resaltado de riesgos en el mismo flujo.",
  "aiDrafting.feat.sign.title": "Firma secuencial",
  "aiDrafting.feat.sign.body": "Los firmantes abren un enlace — sin registro. Cadena gratis hasta 2 firmantes.",
  "aiDrafting.howTitle": "Flujo recomendado",
  "aiDrafting.how.1": "Elige una plantilla en /free-templates o vía MCP list_templates.",
  "aiDrafting.how.2": "Abre Preparar (o draft_from_template → URL de preparación).",
  "aiDrafting.how.3": "Personaliza campos; opcionalmente genera/resume/revisa con IA.",
  "aiDrafting.how.4": "Agrega firmantes y envía — tú controlas el botón de envío.",
  "aiDrafting.faqTitle": "FAQ de redacción con IA",
  "aiDrafting.faq.q1": "¿La IA escribe el contrato completo sola?",
  "aiDrafting.faq.a1": "Puedes generar un PDF desde una descripción (Paid) o partir de una plantilla. Siempre revisa antes de enviar.",
  "aiDrafting.faq.q2": "¿Puede un agente de chat empezar un borrador?",
  "aiDrafting.faq.a2": "Sí vía MCP draft_from_template — el agente devuelve un enlace de preparación. Tú sigues enviando desde Docracy.",
  "aiDrafting.faq.q3": "¿Es asesoría legal?",
  "aiDrafting.faq.a3": "No. Las plantillas y la IA son herramientas; no son un abogado. Usa criterio o consejo profesional.",
  "aiDrafting.faq.q4": "¿Gratis para empezar?",
  "aiDrafting.faq.a4": "Sí para cadenas de hasta 2 firmantes. Las herramientas de IA de Preparar están en Paid.",
  "aiDrafting.footerCta": "Empieza con una plantilla de confianza.",
  "aiDrafting.linkAi": "Detección IA y herramientas →",
  "aiDrafting.linkAnalysis": "Análisis de contratos con IA →",
  "aiDrafting.linkMcp": "Conector MCP →",
  "aiDrafting.linkDevelopers": "Docs para desarrolladores →",

  "enterprise.eyebrow": "Equipos y empresas",
  "enterprise.heroTitle": "E-firma para equipos\nque rechazan el bloat por asiento.",
  "enterprise.heroSub":
    "Precio plano por espacio, conectores, herramientas de IA y MCP de solo lectura — con un camino de ventas humano para volumen y SSO.",
  "enterprise.ctaPrimary": "Ver precios →",
  "enterprise.ctaSecondary": "Confianza y seguridad",
  "enterprise.featuresTitle": "Qué obtiene realmente un comprador enterprise",
  "enterprise.featuresSub": "No vendemos Gemini Enterprise for Legal. Vendemos e-firma rápida más ganchos honestos de IA/MCP en Cloudflare.",
  "enterprise.feat.workspace.title": "Precio plano por espacio",
  "enterprise.feat.workspace.body": "Paid es $10/mes por espacio — agrega compañeros sin impuesto por asiento. Cotizaciones Enterprise para volumen/SSO.",
  "enterprise.feat.governance.title": "Gobernanza básica",
  "enterprise.feat.governance.body": "Registro de auditoría, certificado de finalización, retención corta, borrador de DPA Art. 28, subprocesadores en /trust.",
  "enterprise.feat.mcp.title": "Listo para asistentes (MCP)",
  "enterprise.feat.mcp.body": "Legal ops puede consultar estado y buscar docs desde el chat; las plantillas ayudan a estandarizar borradores.",
  "enterprise.feat.support.title": "Camino de ventas humano",
  "enterprise.feat.support.body": "Contacta sales@docracy.io para facturación, volumen o compras.",
  "enterprise.howTitle": "Despliegue en cuatro pasos",
  "enterprise.how.1": "Empieza en Paid — invita al equipo, conecta Drive/Dropbox si hace falta.",
  "enterprise.how.2": "Estandariza en Marketplace / plantillas gratis para acuerdos recurrentes.",
  "enterprise.how.3": "Opcional: emite tokens MCP para que los asistentes consulten estado con seguridad.",
  "enterprise.how.4": "Pide Enterprise a ventas cuando necesites volumen, SSO o DPA firmado.",
  "enterprise.faqTitle": "FAQ Enterprise",
  "enterprise.faq.q1": "¿Verifican la identidad del firmante?",
  "enterprise.faq.a1": "No. Docracy ofrece firmas SES pensadas para flujos ESIGN/UETA — no AES/QES con ID-V.",
  "enterprise.faq.q2": "¿Dónde se procesan los datos?",
  "enterprise.faq.a2": "Cloudflare (Workers, R2, KV, índice D1). Ver /trust para subprocesadores y retención.",
  "enterprise.faq.q3": "¿Podemos construir playbooks internos con IA?",
  "enterprise.faq.a3": "Aún no como producto de playbook privado entrenado. Usa plantillas + riesgo/resumen, o habla con ventas sobre el roadmap.",
  "enterprise.faq.q4": "¿Acceso de escritura por MCP?",
  "enterprise.faq.a4": "MCP no envía documentos hoy. Es intencional por seguridad.",
  "enterprise.footerCta": "Compara planes o habla con ventas.",
  "enterprise.linkDpa": "Acuerdo de procesamiento de datos →",
  "enterprise.linkMcp": "Conector MCP →",
  "enterprise.linkDocs": "Documentación →",
  "enterprise.linkIntegrations": "Integraciones con asistentes de IA →",

  "integrationsAi.eyebrow": "Integraciones",
  "integrationsAi.heroTitle": "Tus asistentes de IA,\nconectados a plantillas Docracy.",
  "integrationsAi.heroSub":
    "MCP Streamable HTTP en mcp.docracy.io — plantillas y estado gratis; búsqueda de documentos del espacio con clave Paid.",
  "integrationsAi.ctaPrimary": "Guía de configuración MCP →",
  "integrationsAi.ctaSecondary": "Resumen para desarrolladores",
  "integrationsAi.featuresTitle": "Qué pueden hacer los agentes hoy",
  "integrationsAi.featuresSub": "Lectura y asistencia de borrador. El envío sigue siendo humano en docracy.io.",
  "integrationsAi.feat.templates.title": "Catálogo de plantillas en el chat",
  "integrationsAi.feat.templates.body": "list_templates / get_template / draft_from_template contra estándares gratis + Marketplace.",
  "integrationsAi.feat.status.title": "Estado de firma al instante",
  "integrationsAi.feat.status.body": "check_status en cualquier enlace de firma/estado — sin cuenta.",
  "integrationsAi.feat.clients.title": "Claude, ChatGPT, Gemini y más",
  "integrationsAi.feat.clients.body": "Cualquier cliente MCP Streamable HTTP; también Cursor / Claude Code vía JSON.",
  "integrationsAi.feat.limits.title": "Límites honestos",
  "integrationsAi.feat.limits.body": "Sin envío autónomo. find_documents es Paid. No revendemos Gemini Enterprise for Legal.",
  "integrationsAi.howTitle": "Conectar en minutos",
  "integrationsAi.how.1": "Agrega https://mcp.docracy.io/mcp (sin token para plantillas/estado).",
  "integrationsAi.how.2": "Pide list_templates o check_status con un enlace real.",
  "integrationsAi.how.3": "Para docs del espacio: inicia sesión, copia la URL con token dk_.",
  "integrationsAi.how.4": "Usa draft_from_template → abre Preparar → revisa y envía.",
  "integrationsAi.faqTitle": "FAQ de integraciones",
  "integrationsAi.faq.q1": "¿Funciona con Google Gemini?",
  "integrationsAi.faq.a1": "Sí con clientes/agentes Gemini capaces de MCP. No es el producto Gemini Enterprise for Legal de Google.",
  "integrationsAi.faq.q2": "¿Se necesita clave API?",
  "integrationsAi.faq.a2": "No para plantillas ni check_status. Sí para find_documents.",
  "integrationsAi.faq.q3": "¿Puede el agente firmar por mí?",
  "integrationsAi.faq.a3": "No. MCP no firma ni envía.",
  "integrationsAi.faq.q4": "¿Dónde está Zapier?",
  "integrationsAi.faq.a4": "Misma clave Paid — ver la guía MCP / docs de automatización.",
  "integrationsAi.footerCta": "Conecta tu asistente a plantillas de confianza.",
  "integrationsAi.linkAi": "Landing de IA →",
  "integrationsAi.linkDrafting": "Redacción de contratos con IA →",
  ...
  "footer.acta": "Acta de nacimiento",
  "footer.cita": "Cita consular",
  "footer.eadTps": "EAD / TPS",
  "footer.phoneBank": "Chip y banco",
  ...
  "docs.cobro.title": "Cobro por WhatsApp (pago)",
  "docs.cobro.body":
    "Envía un PDF con tu checkout https — sin firmantes. El destinatario recibe correo y/o WhatsApp con una página que tiene el archivo y tu botón de pagar. Aviso opcional cada 30 días hasta que marques pagado. Docracy nunca cobra el dinero. Abre /es/cobro.",
  ...
  "signed.cobroPaid": "Marcado como pagado por el remitente",
  ...
  "dash.sendMoneyNav": "Enviar dinero",
  ...
  "dash.corridorActa": "Saca el acta en origen y luego apostíllala. No la timbramos. Firma el I-9 al llegar.",
  "dash.corridorCita": "DS-160 en CEAC; AIS agenda la entrevista. No compramos el cupo.",
  "dash.corridorEad": "I-765 y TPS son USCIS. No los presentamos. El empleador igual pide la Sección 1.",
  "dash.corridorPhoneBank": "Primero el número, luego el banco. No vendemos ninguno. La constancia es lo que el arrendador nos pide.",
  ...
  "taxYear.kicker": "Pago · archivo fiscal",
  "taxYear.heroTitle": "Archivo para tu contador: cada contrato y cobro del año",
  "taxYear.heroSub":
    "Contratos, cobros y PDFs que ya enviaste por Docracy, listados por año calendario. Exporta nombres, montos, pagado/por cobrar y enlaces. No presentamos declaraciones ni leemos RFC del PDF.",
  "taxYear.ctaOpen": "Abrir el casillero de este año",
  "taxYear.ctaPaid": "Abrir el casillero — $10/mes",
  "taxYear.ctaLogin": "Inicia sesión para abrir el casillero",
  "taxYear.problemTitle": "El problema",
  "taxYear.problem":
    "Llega la declaración y el PDF ya no está. El chat no encuentra nada. El archivo firmado vivió nueve días en una herramienta gratis y se borró. Tu contador quiere una lista, no una búsqueda.",
  "taxYear.solutionTitle": "Qué es esto",
  "taxYear.solution":
    "En el plan de pago, Docracy ya guarda los PDF al menos 13 meses (o hasta el 15 de abril siguiente). Este casillero es ese archivo, filtrado a un año calendario, más una hoja para tu contador. Columnas honestas: fechas, títulos, contrapartes, montos que tú escribiste, pagado o no, tu URL de cobro.",
  "taxYear.feat1": "Cada documento completado en ese año — contratos y cobros.",
  "taxYear.feat2": "CSV: año, fecha, título, nombres, correos, monto, moneda, URL de pago, pagado/por cobrar, fecha de archivo, URL de la copia.",
  "taxYear.feat3": "Sin OCR de RFC o TIN, sin presentación ante el SAT, la DIAN ni el IRS.",
  "taxYear.feat4": "Firmar sigue gratis. El plan de pago es cómo los archivos existen cuando tu contador los pide.",
  "taxYear.lockerTitle": "Archivos completados en {{year}}",
  "taxYear.lockerSub": "La fuente de verdad sigue siendo cada PDF. Este CSV es un índice para tu contador.",
  "taxYear.yearLabel": "Año fiscal",
  "taxYear.count": "{{n}} documento(s) completado(s)",
  "taxYear.downloadCsv": "Descargar CSV para el contador",
  "taxYear.empty": "Aún no hay nada completado en este año calendario.",
  "taxYear.faq.1.q": "¿Docracy presenta ante el SAT, la DIAN o el IRS?",
  "taxYear.faq.1.a": "No. El casillero es una lista de documentos que ya completaste aquí, más un CSV. Tú o tu contador presentan.",
  "taxYear.faq.2.q": "¿Extraen RFC, NIT o números de Seguro Social?",
  "taxYear.faq.2.a": "No. Nunca leemos el PDF para sacar identificadores fiscales. Conserva el archivo firmado y entrégaselo a tu contador.",
  "taxYear.faq.3.q": "¿Qué lleva el CSV?",
  "taxYear.faq.3.a": "Año, fecha, título, nombres y correos, monto y moneda si pegaste un cobro, pagado/por cobrar, fecha de archivo y la URL de la copia.",
  "taxYear.faq.4.q": "¿El archivo es gratis?",
  "taxYear.faq.4.a": "No. En el plan gratis los PDF se borran a los 9 días. El plan de $10/mes los conserva y desbloquea esta lista.",
  "taxYear.faq.5.q": "¿Incluye los cobros por WhatsApp?",
  "taxYear.faq.5.a": "Sí. Un cobro completado (archivo + pago, sin firma) cuenta en el mismo año que los contratos firmados.",
  "taxYear.howToName": "Cómo exportar un CSV del año para tu contador",
  "taxYear.howTo1": "Envía y completa archivos en Docracy durante el año (el plan de pago conserva los PDF).",
  "taxYear.howTo2": "Abre el archivo fiscal y elige el año.",
  "taxYear.howTo3": "Descarga el CSV de títulos, contrapartes, montos y si el cobro está pagado.",
  "taxYear.howTo4": "Entrega la hoja y los PDF a tu contador — nosotros no presentamos declaraciones.",
  "cobro.seoTitle": "Cobra por WhatsApp — sin firma | Docracy",
  "cobro.seoDescription":
    "Envía un PDF y tu Mercado Pago, PayPal o Stripe por WhatsApp. Sin firma. No es CFDI. Docracy nunca cobra el dinero. Plan de $10/mes.",
  "cobro.kicker": "Pago · cobro",
  "cobro.heroTitle": "Cobra por WhatsApp. No hace falta que firmen.",
  "cobro.heroSub":
    "Pega tu Mercado Pago, PayPal.me o Stripe, adjunta la factura o el contrato y envía. Abren una página con el archivo y tu checkout. No es CFDI. Docracy nunca cobra el pago.",
  "cobro.ctaSend": "Enviar un cobro",
  "cobro.ctaPaid": "Desbloquear cobro — $10/mes",
  "cobro.ctaLogin": "Inicia sesión para enviar cobro",
  "cobro.problemTitle": "El problema",
  "cobro.problem":
    "El trabajo ya cerró. Pedir una firma solo para mandar un PayPal es fricción. WhatsApp es donde en LATAM (y muchos contratistas en EE. UU.) sí contestan.",
  "cobro.solutionTitle": "Qué es esto",
  "cobro.solution":
    "Una página de archivo + pago, sin cadena de firmantes. WhatsApp y/o correo. Recordatorio opcional cada 30 días hasta la fecha de archivo o hasta que marques pagado. Tu checkout, tu dinero. No es factura SAT ni DIAN.",
  "cobro.feat1": "No hace falta firmar — el PDF está disponible de inmediato.",
  "cobro.feat2": "0% del cobro. No es CFDI, no somos PAC, no procesamos el pago.",
  "cobro.feat3": "Aviso a 30 días (correo y WhatsApp) para que la factura no se enfríe.",
  "cobro.feat4": "Etiquetas USD, MXN, COP, ARS, CLP, PEN, BRL. Checkout https que controlas tú.",
  "cobro.formTitle": "Enviar archivo + pago",
  "cobro.formHint": "Correo o WhatsApp (o ambos). Monto como 150 o 150.00. Docracy no cobra este dinero.",
  "cobro.fileLabel": "PDF",
  "cobro.titlePh": "Título (p. ej. factura de marzo)",
  "cobro.namePh": "Nombre del destinatario",
  "cobro.emailPh": "Correo (opcional si hay WhatsApp)",
  "cobro.whatsappPh": "WhatsApp (p. ej. +52 55 1234 5678)",
  "cobro.pickTemplate": "O elige una plantilla gratis",
  "cobro.signModeLabel": "¿Esto necesita firma primero?",
  "cobro.signModeOff": "Solo enviarlo",
  "cobro.signModeOffSub": "Sin firma — el archivo está disponible de inmediato",
  "cobro.signModeOn": "Que firmen primero",
  "cobro.signModeOnSub": "Agrega campos — firman y luego ven la página de pago",
  "cobro.signRequiresEmail": "Se necesita el correo del destinatario para que firme primero",
  "cobro.fieldSignature": "Firma",
  "cobro.fieldDate": "Fecha",
  "cobro.fieldPlaceHint": "Elige un tipo de campo y luego haz clic en el documento donde debe ir.",
  "cobro.submit": "Enviar cobro",
  "cobro.submitLogin": "Inicia sesión para enviar este cobro",
  "cobro.submitUpgrade": "Desbloquear cobro — $10/mes",
  "cobro.pickContact": "Rellenar desde un contacto",
  "cobro.payUrlPh": "https://mpago.la/… o PayPal.me/tu",
  "cobro.methodLabel": "¿Cómo quieres cobrar?",
  "cobro.methodLink": "Mi propio enlace",
  "cobro.methodLinkSub": "PayPal, Stripe, Mercado Pago…",
  "cobro.methodCrypto": "Cripto",
  "cobro.methodCryptoSub": "Factura generada automáticamente, se marca pagada sola",
  "cobro.cryptoHint": "Generamos una factura cripto de NOWPayments (QR + enlace) por este monto al enviar. Docracy sigue sin quedarse nada — este cobro se marca pagado automáticamente en cuanto se confirma el pago, sin que tengas que hacer clic.",
  ...
  "cobro.sentBody": "Enviado. Reenvía esta página — el PDF y el botón de pagar siguen aquí hasta la fecha de archivo.",
  "cobro.faq.1.q": "¿Tienen que firmar primero?",
  "cobro.faq.1.a": "No por defecto — el cobro es archivo + pago. Si quieres una firma primero, marca \"Que firmen primero\" en el formulario de envío para agregar un paso de colocación de campos antes de la entrega, con el mismo enlace de pago una vez que terminen.",
  "cobro.faq.2.q": "¿Docracy se lleva un porcentaje?",
  "cobro.faq.2.a": "No. Pegas tu propio checkout https. El plan de $10/mes es cómo le pagan a Docracy, no un recorte del tuyo.",
  "cobro.faq.3.q": "¿Esto es un CFDI o factura del SAT?",
  "cobro.faq.3.a": "No. No somos PAC. Kita y Alegra timbran CFDI. Tú adjuntas el PDF que ya tienes y pegas tu propio checkout.",
  "cobro.faq.4.q": "¿Los vuelven a avisar?",
  "cobro.faq.4.a": "Sí, cada ~30 días hasta que expire el archivo o marques el cobro como pagado, más un reenvío manual desde tu cuenta.",
  "cobro.faq.5.q": "¿El cobro es gratis?",
  "cobro.faq.5.a": "No. Solo plan de pago, igual que los enlaces de cobro en documentos firmados.",
  "cobro.faq.6.q": "¿Se llevan un porcentaje de Mercado Pago?",
  "cobro.faq.6.a": "No. $10/mes es cómo le pagas a Docracy. Mercado Pago cobra su propia comisión.",
  "cobro.howToName": "Cómo enviar una factura por WhatsApp sin firma",
  "cobro.howTo1": "Llena el formulario de cobro (puedes hacerlo antes de iniciar sesión o pagar) y adjunta el PDF.",
  "cobro.howTo2": "Pega tu Mercado Pago, PayPal.me o Stripe Payment Link.",
  "cobro.howTo3": "Agrega el WhatsApp y/o el correo del destinatario y envía.",
  "cobro.howTo4": "Abren la página, descargan el archivo y pagan en tu checkout. Docracy nunca cobra el dinero.",
  "latamPacket.seoTitle": "Contrata en LATAM — NDA, acuerdo y cobro por WhatsApp | Docracy",
  "latamPacket.seoDescription":
    "Incorpora a un contratista que pagas en el extranjero: NDA y acuerdo gratis, luego cobro de pago con PayPal o Mercado Pago. No es un W-8BEN. EN + ES.",
  "latamPacket.kicker": "Empresa en EE. UU. ↔ contratista LATAM",
  "latamPacket.heroTitle": "NDA, acuerdo de contratista y luego cobra — si pagas en el extranjero",
  "latamPacket.heroSub":
    "Dos plantillas gratis existentes y luego cobro por WhatsApp en el plan de pago. Esto no es un W-8BEN ni asesoría fiscal. Si es persona de EE. UU., usa el kit con el W-9 del IRS.",
  "latamPacket.ctaStart": "Empezar con el NDA",
  "latamPacket.stepsTitle": "El corredor",
  "latamPacket.stepsSub": "Envíalos en este orden. Cada plantilla es un envío normal. El cobro es de pago y no exige firma.",
  "latamPacket.cobroStepTitle": "Cobra (cobro por WhatsApp)",
  "latamPacket.cobroStepBody":
    "Plan de pago: envía la factura o el acuerdo firmado más tu PayPal, Stripe o Mercado Pago. Sin otra firma. Docracy nunca cobra el dinero.",
  "latamPacket.cobroCta": "Abrir cobro",
  "latamPacket.usKitHint": "¿Pagas a un contratista de EE. UU.? Usa el kit de EE. UU. (NDA, W-9 del IRS, acuerdo).",
  "latamPacket.backToKit": "Volver al kit LATAM",
  "latamPacket.nextTitle": "Siguiente en el kit LATAM",
  "latamPacket.kitDone": "Corredor LATAM completo en esta sesión",
  "latamPacket.kitDoneSub": "Aún puedes reenviar el NDA o el acuerdo, o mandar otro cobro.",
  "latamPacket.faq.1.q": "¿Esto es un W-8BEN?",
  "latamPacket.faq.1.a": "No. Docracy no publica un W-8BEN. Este kit es NDA + acuerdo + tu checkout. Habla con un asesor fiscal sobre retenciones.",
  "latamPacket.faq.2.q": "¿Cuándo uso el kit de contratista en EE. UU.?",
  "latamPacket.faq.2.a": "Cuando la persona es de EE. UU. para efectos fiscales — necesitas el W-9 del IRS. Ese kit es gratis en /es/kit-contratista.",
  "latamPacket.faq.3.q": "¿El paso de cobro es gratis?",
  "latamPacket.faq.3.a": "Firmar el NDA y el acuerdo es gratis. Pegar tu enlace de cobro / cobro por WhatsApp es el plan de $10/mes.",
  "latamPacket.faq.4.q": "¿Funciona en español?",
  "latamPacket.faq.4.a": "Sí. Esta página es /es/kit-contratista-latam. Las invitaciones siguen el idioma en el que envías.",
  "latamPacket.howToName": "Cómo contratar a alguien en LATAM con Docracy",
  "latamPacket.howTo1": "Envía el NDA mutuo (plantilla gratis).",
  ...
  "latamUsPacket.send.cita.title": "Cita consular → AIS / el contratista de State de tu país",
  "latamUsPacket.send.cita.body":
    "Termina el DS-160 en CEAC y agenda en ais.usvisa-info.com (o el contratista que State liste para tu país). No compramos ni reprogramamos el cupo. Firmamos la oferta y los PDFs de apoyo.",
  "latamUsPacket.send.cita.official": "ais.usvisa-info.com — citas oficiales de State",
  "latamUsPacket.send.cita.cta": "Puerta de la cita",
  "latamUsPacket.send.ead.title": "EAD / TPS → USCIS (tú, no nosotros)",
  "latamUsPacket.send.ead.body":
    "El I-765 es el permiso de trabajo. El TPS es el I-821 en la página de USCIS — las designaciones cambian. Firmar un I-9 aquí no autoriza a trabajar. No presentamos I-765 ni I-821.",
  "latamUsPacket.send.ead.official": "Formulario I-765 de USCIS",
  "latamUsPacket.send.ead.cta": "Puerta EAD / TPS",
  "latamUsPacket.send.acta.title": "Acta → tu registro civil, luego apostilla",
  "latamUsPacket.send.acta.body":
    "México: miregistrocivil.gob.mx (actas nuevas desde el 1 ago 2025), luego apostilla SRE. Otros países: tu registro civil y el .gob del corredor. No emitimos ni timbramos actas.",
  "latamUsPacket.send.acta.official": "México — Plataforma Nacional del Registro Civil",
  "latamUsPacket.send.acta.cta": "Puerta del acta",
  "latamUsPacket.send.phone.title": "Número de EE. UU. + banco → un carrier y un banco (no nosotros)",
  "latamUsPacket.send.phone.body":
    "Casi todo banco pide un número de EE. UU. primero. No vendemos eSIM ni abrimos cuentas. El CFPB explica qué suelen pedir (ID con foto + SSN o ITIN). El arrendador igual quiere la constancia de aquí.",
  "latamUsPacket.send.phone.official": "CFPB — abrir una cuenta",
  "latamUsPacket.send.phone.cta": "Puerta chip y banco",
  ...
  "constancia.receiptsTitle": "PDFs de PayPal / Mercado Pago",
  "constancia.receiptsSub":
    "Adjunta exportaciones que ya tienes. No nos conectamos a PayPal. Los montos del paquete siguen siendo los que escribiste. No es carta bancaria.",
  "constancia.receiptsAdd": "Agregar un PDF",
  "constanciaShare.receiptsTitle": "PDFs adjuntos",
  "taxYear.copyShare": "Copiar enlace para el contador",
  "taxYear.shareHint": "Quien tenga el enlace ve títulos, nombres y montos que escribiste — sin correos. No es un 1099 presentado.",
  "payerShare.kicker": "Contratistas pagados",
  "payerShare.title": "A quién pagamos · {{year}}",
  "payerShare.disclaimer":
    "Esto es un índice de Docracy de archivos completados en el año calendario. No es presentación ante el IRS, no es un 1099-NEC que hayamos presentado, y nunca leemos TIN con OCR.",
  "payerShare.totalsTitle": "Montos anotados",
  "payerShare.empty": "No hay archivos completados en este año.",
  "payerShare.copyLink": "Copiar esta página",
  "payerShare.forwardHint": "¿Necesitas tu casillero?",
  "payerShare.sendYours": "Abrir el archivo fiscal",
  "dash.corridorEarnTitle": "Tú cobras",
  "dash.corridorEarnSub": "Comparte un registro y cobra con tu checkout. Firmar sigue gratis.",
  ...
  "dash.corridorCollectTitle": "Pide W-9 / NDA / RFC",
  "dash.corridorCollect": "Envía el W-9 o el NDA. Para RFC/CSF suben su PDF — no inventamos el formulario.",
  ...
  "footer.latamTradePacket": "Kit comercial LATAM",
  "footer.collectPacket": "Pedir W-9 / NDA",
  "nav.mega.feature.trades.title": "Kit oficios",
  "nav.mega.feature.trades.desc": "Orden de trabajo, change order y cobro con tu checkout.",
  "nav.mega.feature.latamTrade.title": "Docs comerciales LATAM",
  "nav.mega.feature.latamTrade.desc": "Firma el paquete comercial. No presentamos ante aduana.",
  "nav.mega.feature.collect.title": "Pedir W-9 / NDA / RFC",
  "nav.mega.feature.collect.desc": "Tú envías el formulario. No inventamos un RFC.",
  "docs.tradesPacket.title": "Kit oficios",
  "docs.tradesPacket.body":
    "Plantillas de work order y change order (gratis), luego cobro de pago con tu Square/PayPal/Venmo. No enviamos un waiver de gravamen válido en tu estado. Abre /packets/trades.",
  "docs.latamTradePacket.title": "Kit comercial intra-LatAm",
  "docs.latamTradePacket.body":
    "Contrato de compraventa y orden de compra, luego cobro. Honesto: no es packing list, no es certificado de origen, no es aduana, no cotizamos flete. Abre /es/kit-comercio.",
  "docs.collectPacket.title": "Pedir un W-9, NDA o PDF de RFC",
  "docs.collectPacket.body":
    "Tú eres quien envía: W-9 y NDA mutuo son plantillas gratis. Para RFC / Constancia de Situación Fiscal, suben su PDF — Docracy no publica un formulario del SAT. Abre /es/pide-documentos.",
  "docs.payerShare.title": "Compartir el archivo fiscal con un contador",
  "docs.payerShare.body":
    "El casillero de pago en /es/temporada-1099 copia una URL HMAC. La página pública lista títulos, nombres y montos que escribiste. Sin correos, sin OCR de TIN, no es e-file del IRS.",
  "tradesPacket.seoTitle": "Orden de trabajo y change order firmados, luego cobra | Docracy",
  ...
  "tradesPacket.kicker": "Electricistas · HVAC · oficios",
  "tradesPacket.heroTitle": "Firma el trabajo. Luego el anticipo en tu checkout.",
  "tradesPacket.heroSub":
    "Work order y change order son plantillas gratis. El cobro de pago envía tu Square, PayPal o Venmo — Docracy no se queda el dinero. No inventamos un gravamen para tu estado.",
  "tradesPacket.ctaStart": "Empezar con la orden de trabajo",
  "tradesPacket.stepsTitle": "El paquete del trabajo",
  "tradesPacket.stepsSub": "Envíalos en este orden. Cada PDF es un envío normal. El cobro es de pago y no exige firma.",
  "tradesPacket.cobroStepTitle": "Anticipo / factura (cobro)",
  "tradesPacket.cobroStepBody": "Adjunta la orden firmada o la factura y pega tu URL de cobro. WhatsApp o correo.",
  "tradesPacket.cobroCta": "Abrir cobro",
  "tradesPacket.hint": "¿Necesitas el W-9 de un sub? Usa el kit de pedir documentos. Este paquete es para el cliente del trabajo.",
  "tradesPacket.kitDone": "Paquete de oficio completo en esta sesión",
  "tradesPacket.kitDoneSub": "Aún puedes reenviar la orden o mandar otro cobro.",
  "tradesPacket.nextTitle": "Siguiente en el kit de oficios",
  "tradesPacket.tpl.work-order.name": "Orden de trabajo",
  "tradesPacket.tpl.work-order.description": "Alcance, costo estimado y fechas antes de empezar.",
  "tradesPacket.tpl.change-order-agreement.name": "Change order",
  "tradesPacket.tpl.change-order-agreement.description": "Registro firmado cuando cambia el alcance o el precio.",
  "tradesPacket.faq.1.q": "¿Esto es Jobber o Housecall Pro?",
  "tradesPacket.faq.1.a": "No. Ellos se quedan el calendario. Nosotros firmamos el papel y enviamos tu enlace de cobro.",
  "tradesPacket.faq.2.q": "¿Tienen waiver de gravamen mecánico?",
  "tradesPacket.faq.2.a": "No. Los waivers dependen del estado. No enviamos uno falso. Firma el trabajo y luego cobro.",
  "tradesPacket.faq.3.q": "¿El cobro es gratis?",
  "tradesPacket.faq.3.a": "Firmar work order y change order es gratis (2 firmantes). Pegar tu checkout es el plan de $10/mes.",
  "tradesPacket.faq.4.q": "¿Puedo mandarlo por WhatsApp?",
  "tradesPacket.faq.4.a": "Sí — cobro usa WhatsApp o correo. Las invitaciones a firmar también pueden ir por WhatsApp.",
  "tradesPacket.howToName": "Cómo documentar un trabajo de oficio en Docracy",
  "tradesPacket.howTo1": "Envía la orden de trabajo (plantilla gratis).",
  "tradesPacket.howTo2": "Si el trabajo cambia, envía el change order.",
  "tradesPacket.howTo3": "En el plan de pago, envía cobro con tu Square/PayPal/Venmo.",
  "tradesPacket.howTo4": "No uses esto como gravamen presentado. Pregunta a un abogado de construcción por waivers.",
  "latamTradePacket.seoTitle": "Documentos comerciales LatAm — no es aduana | Docracy",
  "latamTradePacket.seoDescription":
    "Firma acuerdo de compraventa y orden de compra, luego cobro. No es packing list de aduana ni certificado de origen.",
  "latamTradePacket.kicker": "Comercio intra-LatAm",
  "latamTradePacket.heroTitle": "Firma el paquete comercial. No llenamos la aduana.",
  "latamTradePacket.heroSub":
    "Acuerdo de compraventa y orden de compra son plantillas gratis. Luego cobro con tu Mercado Pago. No es certificado de origen, no cotizamos flete, no presentamos ante aduana.",
  "latamTradePacket.ctaStart": "Empezar con el contrato de compraventa",
  "latamTradePacket.stepsTitle": "El paquete comercial",
  "latamTradePacket.stepsSub": "Documentos que firmas. No es middleware de aduanas.",
  "latamTradePacket.cobroStepTitle": "Cobro",
  "latamTradePacket.cobroStepBody": "PDF + tu enlace de Mercado Pago o PayPal. Docracy no cobra el dinero.",
  "latamTradePacket.cobroCta": "Abrir cobro",
  "latamTradePacket.hint": "¿Contratas a una persona, no mercancía? Usa el kit contratista LATAM.",
  "latamTradePacket.kitDone": "Paquete comercial listo en esta sesión",
  "latamTradePacket.kitDoneSub": "Puedes reenviar el contrato o mandar otro cobro.",
  "latamTradePacket.nextTitle": "Siguiente en el kit comercial",
  "latamTradePacket.tpl.sales-agreement.name": "Contrato de compraventa",
  "latamTradePacket.tpl.sales-agreement.description": "Precio, entrega y estado para una venta de bienes.",
  "latamTradePacket.tpl.purchase-order.name": "Orden de compra",
  "latamTradePacket.tpl.purchase-order.description": "Qué se pidió, a qué costo y para cuándo.",
  "latamTradePacket.faq.1.q": "¿Esto es software de aduanas?",
  "latamTradePacket.faq.1.a": "No. No llenamos pedimentos, no comparamos fletes ni presentamos ante aduana.",
  "latamTradePacket.faq.2.q": "¿Tienen certificado de origen?",
  "latamTradePacket.faq.2.a": "No. Los certificados preferenciales son oficiales. No inventamos uno.",
  "latamTradePacket.faq.3.q": "¿Funciona en español?",
  "latamTradePacket.faq.3.a": "Sí. La URL principal es /es/kit-comercio. Las invitaciones siguen el idioma en el que envías.",
  "latamTradePacket.faq.4.q": "¿El cobro es gratis?",
  "latamTradePacket.faq.4.a": "Firmar los PDF comerciales es gratis. El cobro por WhatsApp es el plan de $10/mes.",
  "latamTradePacket.howToName": "Cómo documentar una venta intra-LatAm con Docracy",
  "latamTradePacket.howTo1": "Envía el contrato de compraventa.",
  "latamTradePacket.howTo2": "Envía la orden de compra.",
  "latamTradePacket.howTo3": "En el plan de pago, cobro con Mercado Pago o PayPal.",
  "latamTradePacket.howTo4": "Contrata un agente aduanal para la presentación real.",
  "collectPacket.seoTitle": "Pídeme tu W-9 o NDA — Docracy",
  ...
  "collectPacket.kicker": "Agencias · empresas en EE. UU. · contratistas LATAM",
  "collectPacket.heroTitle": "Pídeme tu W-9, NDA o PDF de RFC.",
  "collectPacket.heroSub":
    "Tú envías la plantilla; ellos llenan y firman. El W-9 del IRS y el NDA mutuo son gratis. Para RFC o Constancia de Situación Fiscal suben el PDF que ya tienen — Docracy no publica un formulario del SAT.",
  "collectPacket.ctaStart": "Enviar el W-9",
  "collectPacket.stepsTitle": "Pide el papel",
  "collectPacket.stepsSub": "Tú sigues siendo quien envía. El firmante no necesita cuenta.",
  "collectPacket.prepareStepTitle": "PDF de RFC / CSF que ya tienen",
  "collectPacket.prepareStepBody":
    "Sube una portada o su archivo y envíalo para que firmen o adjunten. El plan de pago puede exigir una carga del firmante. No leemos TIN con OCR.",
  "collectPacket.prepareCta": "Subir un PDF",
  "collectPacket.hint": "Personas de EE. UU.: el kit W-9 también está en /es/kit-contratista. En el extranjero: aquí no hay W-8BEN.",
  "collectPacket.kitDone": "Kit de solicitud completo en esta sesión",
  "collectPacket.kitDoneSub": "Puedes enviar otro W-9 o NDA cuando quieras.",
  "collectPacket.nextTitle": "Siguiente en el kit de solicitud",
  "collectPacket.tpl.w-9-form.name": "W-9 del IRS",
  "collectPacket.tpl.w-9-form.description": "Pide el TIN a una persona de EE. UU. Nunca leemos el TIN con OCR.",
  "collectPacket.tpl.mutual-nda.name": "NDA mutuo",
  "collectPacket.tpl.mutual-nda.description": "Ambas partes mantienen la conversación confidencial.",
  "collectPacket.faq.1.q": "¿Es un enlace reutilizable que llenan sin que yo envíe?",
  "collectPacket.faq.1.a": "No es un buzón público. Tú envías cada W-9 o NDA. Así el archivo completado cae en tu bóveda de pago.",
  "collectPacket.faq.2.q": "¿Tienen RFC o W-8BEN?",
  "collectPacket.faq.2.a": "No. No inventamos formularios del SAT ni del IRS. Suben su Constancia de Situación Fiscal.",
  "collectPacket.faq.3.q": "¿Leen el número de Seguro Social?",
  "collectPacket.faq.3.a": "No hay OCR de TIN. Conserva el PDF firmado y dáselo a tu contador.",
  "collectPacket.faq.4.q": "¿Es gratis?",
  "collectPacket.faq.4.a": "Firmar W-9 y NDA es gratis hasta 2 personas. Conservar archivos más de 9 días y exigir adjuntos es el plan de pago.",
  "collectPacket.howToName": "Cómo pedir un W-9 o NDA en Docracy",
  "collectPacket.howTo1": "Envía la plantilla W-9 del IRS a una persona de EE. UU.",
  "collectPacket.howTo2": "Envía el NDA mutuo si necesitas confidencialidad primero.",
  "collectPacket.howTo3": "Para RFC/CSF, sube su PDF o una portada.",
  "collectPacket.howTo4": "Comparte el año con tu contador desde el casillero 1099 — no presentamos ante el IRS.",
  "footer.whoFiles": "Quién sube dónde",
  "dash.corridorWhoFiles": "Marca cada PDF: empleador, USCIS, CBP, IRS o tu país. Tú lo subes. Nosotros no tramitamos.",
  "whoFiles.seoTitle": "Quién sube dónde — I-9, USCIS, CEAC, I-94, apostilla | Docracy",
  ...
  "whoFiles.kicker": "Tú lo subes · nosotros no tramitamos",
  "whoFiles.heroTitle": "Quién recibe este archivo. Tú lo subes.",
  "whoFiles.heroSub":
    "Marca cada fila cuando lo entregues. Los portales oficiales se abren en otra pestaña. El mismo plan de $10/mes firma los extras y guarda los PDF. No presentamos USCIS, DS-160, AR-11, W-7 ni apostilla.",
  "whoFiles.ctaPaid": "Desbloquear el plan inmigrante — $10/mes",
  ...
  "whoFiles.group.file": "Tú o tu gestor lo suben",
  "whoFiles.group.after": "Después de llegar",
  "whoFiles.group.origin": "Tu país / familia",
  "whoFiles.group.money": "Arrendador y clientes",
  "whoFiles.apostillePick": "Oficina de apostilla / legalización de tu país",
  "whoFiles.apostillePickHint":
    "Elige el país del que saliste. El link es la página de ese gobierno — no nosotros. Cuba es legalización en MINJUS, no Apostilla.",
  "whoFiles.apostillePickEmpty": "Elige un país…",
  "whoFiles.everify.title": "E-Verify → el empleador (DHS lo inscribe)",
  "whoFiles.everify.body":
    "Si el empleador usa E-Verify, se inscribe en e-verify.gov después de revisar las Listas A/B/C. Firmar la Sección 1 o 2 aquí no abre un caso.",
  "whoFiles.everify.official": "e-verify.gov (oficial)",
  "whoFiles.weDont.offer": "No mandamos esto a USCIS. El empleador guarda el PDF.",
  "whoFiles.weDont.i9": "Inspeccionar Listas A/B/C ni correr E-Verify. El empleador conserva el formulario — no lo envíes a USCIS.",
  "whoFiles.weDont.everify": "Inscribir al empleador ni abrir un caso de E-Verify.",
  "whoFiles.weDont.visa": "Presentar I-129, I-130, I-485, I-864 ni un paquete consular.",
  "whoFiles.weDont.ceac": "Inventar ni enviar el DS-160. Tú lo subes en CEAC.",
  "whoFiles.weDont.cita": "Comprar, guardar o reprogramar un cupo consular.",
  "whoFiles.weDont.ead": "Presentar I-765, I-821 o conceder TPS / autorización de trabajo.",
  "whoFiles.weDont.acta": "Emitir el acta ni apostillarla.",
  "whoFiles.weDont.phone": "Vender un chip / eSIM ni abrir una cuenta de banco.",
  "whoFiles.weDont.uscis": "Presentar la petición. Boundless, un abogado o tú usan myaccount.uscis.gov.",
  "whoFiles.weDont.uscisAccount": "Abrir ni recuperar una cuenta USCIS.",
  "whoFiles.weDont.i94": "Bajar ni hospedar el registro de admisión. Eso es CBP.",
  "whoFiles.weDont.address": "Presentar el AR-11. Usa uscis.gov/addresschange — casi siempre la cuenta en línea.",
  "whoFiles.weDont.ssn": "Presentar el SS-5 ni emitir un número de Seguro Social.",
  "whoFiles.weDont.itin": "Preparar ni enviar el W-7. No inventamos ese formulario ni hay W-8BEN.",
  "whoFiles.weDont.w9": "Decidir si eres persona de EE. UU. ni inventar un W-8BEN.",
  "whoFiles.weDont.apostille": "Timbrar, mensajear ni legalizar. Eso es SRE, Cancillería, MINJUS o tu cancillería.",
  "whoFiles.weDont.poa": "Apostillar el poder. Fírmalo aquí; el sello es en origen.",
  "whoFiles.weDont.child": "Comprar boletos ni hablar con CBP del menor.",
  "whoFiles.weDont.lease": "Notariar el arrendamiento ni garantizar que el landlord acepte la constancia.",
  "whoFiles.weDont.constancia": "Emitir un W-2 ni la CSF del SAT. Es una URL índice de Docracy.",
  "whoFiles.weDont.cobro": "Cobrar el dinero ni timbrar CFDI / DIAN. Pegas tu Mercado Pago o PayPal.",
  "whoFiles.faq.1.q": "¿Presentan esto ante USCIS o CEAC?",
  "whoFiles.faq.1.a":
    "No. Tú (o tu abogado / Boundless / CitizenPath) lo subes. Firmamos los PDF de apoyo y te decimos qué pestaña oficial abrir.",
  "whoFiles.faq.2.q": "¿Corren E-Verify o revisan los documentos del I-9?",
  "whoFiles.faq.2.a":
    "No. Firmamos las Secciones 1 y 2. El empleador revisa las Listas A/B/C y, si usa E-Verify, se inscribe en e-verify.gov.",
  "whoFiles.faq.3.q": "¿Apostillan papeles de México o Colombia?",
  "whoFiles.faq.3.a":
    "No. Elige tu país en la lista — SRE, Cancillería o la página .gob verificada. Cuba es legalización en MINJUS, no Apostilla.",
  "whoFiles.faq.4.q": "¿Envían el W-7 o bajan el I-94?",
  "whoFiles.faq.4.a":
