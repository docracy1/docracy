...
const en: Messages = {
  ...
  "hero.hint": "No credit card required · no account needed to start.",
  ...
  "prepare.tapPlaceHint": "Select a field type, then tap where it should go on the PDF.",
  "prepare.placeModeBanner": "Placing {{type}} · {{signer}}",
  "prepare.placeModeHint": "Tap the document to place this field",
  "prepare.donePlacing": "Done",
  "prepare.setup": "Setup",
  "prepare.hideSetup": "Hide setup",
  "prepare.mobilePlaceInstruction":
    "Pick a signer, tap Place field, then tap the document where it should go.",
