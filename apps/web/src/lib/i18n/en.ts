...
const en: Messages = {
  ...
  "docs.taxYear.body":
    "Paid accounts can open /1099-season (Spanish: /es/temporada-1099) and download a CSV of every completed document from a calendar year: title, counterparties, emails, amount, currency, payment URL, archive date, signed-page URL. We do not OCR TINs or e-file 1099s with the IRS. The CSV is an index of what you already sent through Docracy.",
  "docs.cobro.title": "WhatsApp cobro (paid)",
  "docs.cobro.body":
    "POST a PDF with your own https checkout — no signers. The recipient gets email and/or WhatsApp (live signing_invite template, signing_link slot) pointing at /signed/… with the file and pay button. Optional 30-day ping. Docracy never takes the money. Open /cobro (Spanish: /es/cobro).",
  ...
  "taxYear.feat2": "CSV: year, completed date, title, names, emails, amount, currency, payment URL, archive date, signed-page URL.",
  ...
  "taxYear.faq.3.a": "Year, completed date, title, counterparty names and emails, amount and currency if you attached a payment link, archive date, and the shareable signed-page URL.",
  ...
  "cobro.seoDescription":
    "Send a PDF and your PayPal, Stripe, or Mercado Pago link on WhatsApp. No signature. Docracy never takes the money. Paid $10/mo, 30-day ping included.",
  "cobro.kicker": "Paid · cobro",
  "cobro.heroTitle": "Get paid on WhatsApp. They don't have to sign.",
  "cobro.heroSub":
    "Paste your PayPal.me, Stripe Payment Link, or Mercado Pago URL, attach the invoice or contract, and send. The recipient opens a page with the file and your checkout. Docracy never collects the payment.",
  ...
  "cobro.solution":
    "A pay + file page with no signer chain. Email and/or WhatsApp using the same live invite template as signing links. Optional reminder about every 30 days until the archive date. Your checkout, your money.",
  "cobro.feat1": "No signature required — the PDF is available immediately.",
  "cobro.feat2": "WhatsApp uses the approved signing_invite template (signing_link = this page). Counts against monthly WhatsApp quota.",
  ...
  "cobro.faq.3.q": "Is this a new WhatsApp template from Meta?",
  "cobro.faq.3.a": "No. We reuse the live signing_invite template and put the pay-page URL in the signing_link variable.",
  "cobro.faq.4.q": "Will you ping them again?",
  "cobro.faq.4.a": "Yes, about every 30 days until the file expires or you mark the cobro paid, plus a manual send-again from your account. Each WhatsApp ping uses quota.",
  ...
  "cobro.howTo2": "Paste your PayPal.me, Stripe Payment Link, or Mercado Pago URL.",
