...
const en: Messages = {
  ...
  "hero.uploadCircleCaption": "Add signers next — nothing sent until you're ready. Google Doc instead? You can paste a link on the next step.",
  ...
  "prepare.uploadHint": "Upload the PDF you want signed, drag and drop it below, or paste a Google Docs link.",
  ...
  "prepare.pdfOnly": "Only PDF files are supported here — for a Google Doc, paste its link in the field below instead.",
