...
const en: Messages = {
  ...
  "hero.uploadCircleSub": "Free e-sign · no signup",
  ...
  "freeTemplates.heroHeadline": "Free contracts & templates",
  "freeTemplates.heroSub":
    "Lawyer-reviewed agreements ready to fill and send. Search, open one, and collect signatures in minutes — free.",
  "freeTemplates.templateCount": "{{count}} templates ready to sign",
  "freeTemplates.howItWorksLink": "How the Marketplace works →",
  "freeTemplates.searchPlaceholder": "Search contracts — NDA, offer letter, lease…",
