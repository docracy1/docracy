...
const en: Messages = {
  ...
  "landing.faq10.a":
    "The all-in-one packet is Paid ($10/month). Sign the offer and the official USCIS I-9 (we don't inspect List A/B/C or run E-Verify). For a visa we sign supporting docs — we don't file I-129 or DS-160. Constancia for a landlord. Compare Boundless / CitizenPath / gestoría: we are the $10 extras, not the filing. Start at /es/kit-llegar-eeuu.",
  ...
  "landing.out7.body":
    "Paid $10/mo is the whole packet: official I-9, visa supporting docs, where to send each file, constancia, cobro. Not Boundless — we don't file the petition or run E-Verify.",
  ...
  "seoVs.immigrantCta": "Unlock the immigrant packet — $10/month",
  ...
  "seoVs.immigrantMidBody": "They file or prepare the petition. We sign the $10 packet around it — I-9, offer, constancia, cobro.",
  "seoVs.esignMidCta": "Try a real agreement — no signup required",
  "seoVs.latamMidCta": "Open the cobro form",
  "seoVs.immigrantMidCta": "Open the immigrant packet",
  ...
  "alt.boundless.solution":
    "Unlock Paid ($10/month). Sign the official I-9 and the supporting templates we already ship. Share a constancia URL. Send cobro if you still invoice. The playbook on the immigrant kit tells you where each file goes. If you still need Boundless to file, keep them — attach our signed PDFs.",
  "alt.boundless.c1": "$10/month vs Boundless FAQ (11 Jun 2026): marriage GC $699/$1,349; K-1 $1,379/$2,549; B-1/B-2 $195+$185. USCIS extra.",
  "alt.boundless.c2": "Official USCIS I-9 + offer, POA, reference, child travel, lease — we don't file the petition",
  "alt.boundless.c3": "Where-to-send map: employer keeps I-9; lawyer/consulate gets the rest; you file DS-160 on CEAC",
  "alt.boundless.c4": "Same Paid plan: constancia for a US landlord + WhatsApp cobro if you still invoice MX/CO",
  "alt.boundless.c5": "Boundless is better if you need them to prepare and file. We are the $10 extras around that filing.",
  "alt.boundless.ctaLabel": "Unlock the immigrant packet — $10/month",
  ...
  "alt.citizenpath.c2": "We sign official I-9 and supporting templates they often ask you to attach",
  "alt.citizenpath.c3": "We do not prepare or file I-129 / I-130 / I-485 / DS-160",
  "alt.citizenpath.c4": "Constancia + cobro in the same $10 workspace after you arrive",
  "alt.citizenpath.c5": "CitizenPath is better when you need DIY USCIS forms. Use both if they asked for signed extras.",
  "alt.citizenpath.ctaLabel": "Unlock the immigrant packet — $10/month",
  ...
  "alt.visaService.c4": "Same plan as cobro and constancia after you land",
  "alt.visaService.c5": "Hire a gestoría when you need them to file. Use Docracy when you need the packet signed.",
  "alt.visaService.ctaLabel": "Unlock the immigrant packet — $10/month",
  ...
  "dash.migrantChecklist": "Migrant checklist",
  "dash.migrantOverviewTitle": "Migrant checklist",
  "dash.migrantOverviewSub": "What to sign, where each file goes, then constancia and cobro. We don't file the petition.",
  ...
  "latamUsPacket.seoTitle": "Immigrant packet — I-9, visa docs, constancia | Docracy",
  ...
  "latamUsPacket.kicker": "LATAM immigrants → United States · all-in-one Paid packet",
  "latamUsPacket.heroTitle": "The whole packet. What to do, where to send it, $10/month.",
  "latamUsPacket.heroSub":
    "Official USCIS I-9, visa supporting docs, offer, POA, constancia for a Houston or Miami landlord, cobro if you still invoice — plus the official links where each file actually goes. We don't file I-129 or DS-160 and we don't run E-Verify. Using the package is Paid.",
  "latamUsPacket.ctaLogin": "Sign in to unlock the packet",
  "latamUsPacket.ctaPaid": "Unlock the immigrant packet — $10/month",
  "latamUsPacket.ctaOpen": "Open the constancia",
  "latamUsPacket.ctaCobro": "Send a cobro",
  "latamUsPacket.paidTitle": "What Paid is for",
  "latamUsPacket.paidSub": "The $10/month plan is how you use this packet after they sign. Same plan as cobro and the constancia — not a separate immigrant fee.",
  "latamUsPacket.paidItem1": "Keep completed PDFs past 9 days (through the next April 15 or 13 months).",
  ...
  "latamUsPacket.paidItem4": "One workspace. I-9, offer, POA, and the rest stay in the same vault.",
  "latamUsPacket.freeHint": "Signing the official I-9 or an offer letter once is still free, no account. Free files disappear after 9 days. That is why the packet is Paid.",
  ...
  "latamUsPacket.faq.6.a":
    "To read the playbook and official links, no. To send, keep files, share a constancia, or send cobro, yes — $10/month. Free signing deletes PDFs after 9 days.",
  "latamUsPacket.faq.7.q": "Is this Boundless, CitizenPath, or a gestoría de visa?",
  "latamUsPacket.faq.7.a":
    "No. Those file or prepare USCIS/State petitions and charge hundreds to thousands. We sign the supporting packet and tell you where to send each file. Compare: /boundless-alternative, /citizenpath-alternative, /visa-service-alternative.",
  ...
  "latamUsPacket.compareSub":
    "They file or prepare petitions. Boundless FAQ (Jun 2026): $699–$2,549 per case + USCIS. CitizenPath: $79–$279 per package + USCIS. MX gestorías we checked: ~$900–$3,800 MXN + $185 State. We are $10/month for the signed extras.",
  "latamUsPacket.howToName": "How to use the immigrant packet",
  "latamUsPacket.howTo1": "Unlock Paid ($10/month) — that is the all-in-one package.",
  "latamUsPacket.howTo2": "Sign I-9, offer, and visa supporting docs. Employer keeps the I-9; lawyer/consulate gets the rest.",
