...
const en: Messages = {
  ...
  "ai.heroSub":
    "Upload a PDF or Google Doc and let AI find every signature and date field, summarize the deal in plain English, and flag clauses worth a second look — then send for signature.",
