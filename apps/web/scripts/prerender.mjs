...
const routes = [
  ...
  {
    urlPath: "/es/acta",
    outFile: "es/acta.html",
    title: getFeaturePageContent("acta", "es").seoTitle,
    description: getFeaturePageContent("acta", "es").seoDescription,
    locale: "es",
    alternates: { en: "/acta", es: "/es/acta" },
    xDefault: "es",
  },
  {
    urlPath: "/es/cita-consular",
    outFile: "es/cita-consular.html",
    title: getFeaturePageContent("consular-appointment", "es").seoTitle,
    description: getFeaturePageContent("consular-appointment", "es").seoDescription,
    locale: "es",
    alternates: { en: "/consular-appointment", es: "/es/cita-consular" },
    xDefault: "es",
  },
  {
    urlPath: "/es/ead-tps",
    outFile: "es/ead-tps.html",
    title: getFeaturePageContent("ead-tps", "es").seoTitle,
    description: getFeaturePageContent("ead-tps", "es").seoDescription,
    locale: "es",
    alternates: { en: "/ead-tps", es: "/es/ead-tps" },
    xDefault: "es",
  },
  {
    urlPath: "/es/chip-y-banco",
    outFile: "es/chip-y-banco.html",
    title: getFeaturePageContent("phone-and-bank", "es").seoTitle,
    description: getFeaturePageContent("phone-and-bank", "es").seoDescription,
    locale: "es",
    alternates: { en: "/phone-and-bank", es: "/es/chip-y-banco" },
    xDefault: "es",
  },
