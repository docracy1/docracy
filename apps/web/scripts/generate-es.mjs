...
const NEW_ES = {
  ...
  "integrations.sub": "Integra las plataformas que ya usas — nube, automatización, IA y el checkout que ya tienes. Las cuentas de pago desbloquean conectores nativos. WhatsApp entrega firma y cobro. PayPal, Stripe, Mercado Pago, Square y Venmo son tu enlace pegado — no nos quedamos el dinero.",
  "integrations.detail": "Dropbox, OneDrive, Box y Google Drive suben PDFs firmados automáticamente. En cobro pegas PayPal.me, Stripe Payment Link, Mercado Pago, Square o Venmo. Zapier y webhooks automatizan tu stack. MCP conecta Claude, ChatGPT, Grok, Perplexity y Cursor a tus documentos.",
