# Email batch — persona templates

Fully written emails. Replace `{{name}}` (and optional `{{detail}}`). CTA: **https://docracy.io/go/dm**

Use with prospects in `prospects.md` or your own list. Keep first line personalized.
...
**Subject:** quick question on client NDAs

> Hey {{name}} — {{detail | e.g. saw your portfolio / retainer work / contract-on-kickoff flow}}.
>
...
## Agency ops / studio producer

### 3 — contractor onboarding

**Subject:** contractor NDAs without DocuSign seats

> Hey {{name}} — do your contractors still get DocuSign seats for one-off agreements?
>
...
## People ops / fractional HoP

### 5 — early-stage people stack

**Subject:** lighter e-sign for contractor NDAs
...
**Subject:** onboarding docs without the DocuSign tax
...
## Indie SaaS founder / solo consultant

### 7 — founder hiring first contractors

**Subject:** NDAs without another SaaS seat
...
## LinkedIn / X DM variants (same personas)
